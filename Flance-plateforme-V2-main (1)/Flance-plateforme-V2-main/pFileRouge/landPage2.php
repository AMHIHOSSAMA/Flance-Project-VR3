...
<div class="container">
  <div class="row">
    <div id="" class="col">
      ...
      <div class="row">
        <div class="col">
        <button type="button" id="btn3" class="btn"><a href="selection.php">Rejoignez-nous</a></button>
        </div>
        <div class="col">
    ...
    <div class="col">
      <img id="heroimage" src="images/hero_Image.png" alt="">
    </div>
  </div>
</div>
...
<div class="container" id="solicodersLogo">
    ...
    <div class="row g-0">
      ...
      <div id="sndparts" class="col-6 col-md-5">
        ...
        <hr>
          ...
          <button type="button" id="btn10" class="btn"><a href="selection.php">Rejoignez-nous</a></button>
