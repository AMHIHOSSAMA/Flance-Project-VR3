    ...
    <div class="container " id="prfCont1">
        <div  class="row d-flex justify-content-center">
            ...
            ?>
                    ...
                    <input  type="submit" id="btnlogin"  value="Ajouter" class="btn btn-outline btnAddproject">
                    </div>
                    ...
                    if ($result = mysqli_query($conn, $sql)) {
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            <div class='card-body'>
                              ...
                              <p class='card-text '>". $row['descriProj'] ."</p>
                              <div class='row'>
                                <div class='col-7'>
                                ...
                                <div class='col'>
                                    <i id='deleteIcon' name='delet_btn' class='fa-regular fa-trash-can'></i>
                                    <i id='editeIcon' name='' class='fa-regular fa-pen'></i>
                                </div>
